plot4 <-function() {
  ...
  par(mfrow = c(2, 2))
  #plot1
  plot(mydf1$Datetime, mydf1$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
  #plot2
  plot(mydf1$Datetime, mydf1$Voltage, type = "l", ylab = "Voltage",xlab = "Datetime")
  #plot3
  ...
  #plot4
  plot(mydf1$Datetime, mydf1$Global_reactive_power, type = "l", xlab = "Datetime", ylab = "Global Reactive Power",ylim=c(0,0.5))
  dev.off()
} 